...
public class RVLapakAdapterHorizontal extends RecyclerView.Adapter<RVLapakAdapterHorizontal.ViewHolder> {
    ...
    public RVLapakAdapterHorizontal(Context context, List<LapakModel> list){
        super();
    ...
    @Override
    public RVLapakAdapterHorizontal.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_lapak_horizontal, parent, false);
